...
// AI options
OPT bool sneakyAI, brutalAI, cheatOnMovement, brutalCivilians, ignoreDelay, allowPreprime, autoCombat, autoAggression, aiPerformanceOptimization;
OPT int aiTargetMode, aiLeeroyMode;
