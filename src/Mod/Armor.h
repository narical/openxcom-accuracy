...
public:
	...
	/// Multiplier of strife move cost.
	ArmorMoveCost getMoveCostStrife() const { return _moveCostStrife; }
	...
	/// Multiplier of fly "strife" cost.
	ArmorMoveCost getMoveCostFlyStrife() const { return _moveCostFlyStrife; }
