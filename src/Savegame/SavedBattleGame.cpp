...
void SavedBattleGame::load(const YAML::YamlNodeReader& node, Mod *mod, SavedGame* savedGame)
{
	...
	else
	{
		...
		serKey._lastExploredByHostile = reader["lastExploredByHostile"].readVal<int>(serKey._lastExploredByHostile);
		serKey._lastExploredByNeutral = reader["lastExploredByNeutral"].readVal<int>(serKey._lastExploredByNeutral);
		serKey._lastExploredByPlayer = reader["lastExploredByPlayer"].readVal<int>(serKey._lastExploredByPlayer);
