 ...
 */
BaseView::BaseView(int width, int height, int x, int y) : InteractiveSurface(width, height, x, y), _base(0), _texture(0), _selFacility(0), _selCraft(0), _big(0), _small(0), _lang(0), _gridX(0), _gridY(0), _selSizeX(0), _selSizeY(0), _selector(0), _blink(true), _cellColor(0), _selectorColor(0)
{
	// Clear grid
