...
${LangFileString} SETUP_XCOM_FOLDER_TITLE "Choisissez Emplacement X-COM"
...
${LangFileString} SETUP_UNUSER "Détruit les Données Utilisateur"
${LangFileString} SETUP_UNUSER_DESC "Détruit toutes les données utilisateur ${GAME_NAME}, y-compris les mods, parties sauvées, captures d'écrans et options. Utiliser uniquement pour une suppression complète."
