...
${LangFileString} SETUP_XCOM_FOLDER_TITLE "Επιλέξτε θέση εγατάστασης του X-COM"
...
${LangFileString} SETUP_GAME "Αρχεία παιχνίδιου"
...
${LangFileString} SETUP_UNUSER "Διαγραφή δεδομένων χρήστη"
...
${LangFileString} SETUP_SHORTCUT_USER "Φάκελος χρήστη"
