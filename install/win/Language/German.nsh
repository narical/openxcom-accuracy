...
${LangFileString} SETUP_GAME_DESC "Benötigte Dateien ${GAME_NAME}."
${LangFileString} SETUP_PORTABLE "Portable Installation"
${LangFileString} SETUP_PORTABLE_DESC "$ {GAME_NAME} speichert Benutzerdaten im Installationsordner. \nDer Ordner muss vom beschreibbar sein."
${LangFileString} SETUP_DESKTOP "Verknüpfung auf dem Desktop"
${LangFileString} SETUP_DESKTOP_DESC "Erstellt eine Verknüpfung auf dem Desktop ${GAME_NAME}."
...
${LangFileString} SETUP_WARNING_UFO "X-COM 1 wurde nicht im Ordner gefunden. ${GAME_NAME} benötigt eine gültige Installation von X-COM 1 um Starten zu können. Fortfahren?"
${LangFileString} SETUP_WARNING_TFTD "X-COM 2 wurde nicht im Ordner gefunden. ${GAME_NAME} benötigt eine gültige Installation von X-COM 2 um Starten zu können. Fortfahren?"
${LangFileString} SETUP_WARNING_XCU "XcomUtil wurde erkannt. ${GAME_NAME} ist inkompatibel mit XcomUtil und könnte nicht richtig funktionieren. Fortfahren?"
